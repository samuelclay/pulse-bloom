...
unsigned int bpmPulseA = 0;
unsigned int bpmPulseB = 0;
...
void loop() {
    bool heartbeat1 = nextPulseATime < millis();
    bool heartbeat2 = nextPulseBTime < millis();
